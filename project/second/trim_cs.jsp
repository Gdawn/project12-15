...
<html>
  ...
  <font face="楷体" size="4">
  <s:iterator value="last_trim" status="st">
  <table  border="2px" id="adm_user" cellspacing="0" align="center">
  <caption style="height:30px; font-size:20px">
  查询结果&emsp;&emsp;&emsp;<a href="allsearch.action?order=2" style="text-decoration:none">返回</a>
  </caption>
  ...
  <td width="240px" colspan="3">报修原因</td>
  ...
  <td width="240px" colspan="3"><s:property value="reason"/></td>
