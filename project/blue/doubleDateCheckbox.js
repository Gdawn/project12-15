 ...
 $.fn.kuiDate = function(k_date){
	...
	//确认所选按钮
	$('.kui_date_reset span.sureSubmit').live('click',function(){
		var t =[];
		var y = '';
			...
			for(var i=0;i<kui_td_lines;i++){
				...
				if(i == 0){
					...
					for(var j=bb+1;j<=7;j++){
						...
						//arr_tr.push('<dt class="'+cla+'" onmouseover="kui_mouseover_(this)" onmouseout="kui_mouseout_(this)" onclick="kui_click_(this,'+now_date+','+kui_y+','+kui_m+','+kui_d+');"><input type="checkbox" />'+(7*i+kui_i)+'</dt>');
						  arr_tr.push('<dt class="'+cla+'" onmouseover="kui_mouseover_(this)" onmouseout="kui_mouseout_(this)"><input class="checkboxChecked" type="checkbox" value="'+(7*i+kui_i)+'" />'+(7*i+kui_i)+'</dt>');
						kui_i++;
					}
					...
					for(var j=1;j<=7;j++){
						...
						if((7*(i-1)+kui_i) > this_max_date){
							...
							//arr_tr.push('<dt class="'+cla+'" onmouseover="kui_mouseover_(this)" onmouseout="kui_mouseout_(this)" onclick="kui_click_(this,'+now_date+','+kui_y+','+kui_m+','+kui_d+');"><input type="checkbox" />'+(7*(i-1)+kui_i)+'</dt>');
							arr_tr.push('<dt class="'+cla+'" onmouseover="kui_mouseover_(this)" onmouseout="kui_mouseout_(this)"><input class="checkboxChecked" type="checkbox" value="'+(7*(i-1)+kui_i)+'" />'+(7*(i-1)+kui_i)+'</dt>');
						}
						kui_i++;
					}
				}
					...
					for(var j=1;j<=7;j++){
						...
						//arr_tr.push('<dt class="'+cla+'" onmouseover="kui_mouseover_(this)" onmouseout="kui_mouseout_(this)" onclick="kui_click_(this,'+now_date+','+kui_y+','+kui_m+','+kui_d+',1);"><input type="checkbox" />'+(7*(i-1)+kui_i)+'</dt>');
						  arr_tr.push('<dt class="'+cla+'" onmouseover="kui_mouseover_(this)" onmouseout="kui_mouseout_(this)"><input class="checkboxChecked" type="checkbox" value="'+(7*(i-1)+kui_i)+'" />'+(7*(i-1)+kui_i)+'</dt>');
						kui_i++;
					}
				}
...
$(function(){
	/* 日期插件的HTML元素 */
	var kui_div_date = '<div class="kui_d_pane" id="kui_d_pane" style="display:none;"><iframe id="kui_frame_d" width="370" height="203" frameborder="0"></iframe></iframe><div class="kui_data_content_pane"><div class="kui_prev_next_month"><a href="javascript:;" class="kui_prev_m"></a><span class="kui_today"></span><a href="javascript:;" class="kui_next_m"></a><span class="kui_tomorrow"></span></div><div id="left_table"><dl class="kui_data_tab"><dt class="d_th_bg">日</dt><dt>一</dt><dt>二</dt><dt>三</dt><dt>四</dt><dt>五</dt><dt class="d_th_bg">六</dt></dl><dl class="kui_date_info" id="kui_left_t"></dl></div><div id="middle_table"><dl class="kui_data_tab"><dt class="d_th_bg">日</dt><dt>一</dt><dt>二</dt><dt>三</dt><dt>四</dt><dt>五</dt><dt class="d_th_bg">六</dt></dl><dl class="kui_date_info" id="kui_middle_t"></dl></div><div id="right_table"><dl class="kui_data_tab"><dt class="d_th_bg">日</dt><dt>一</dt><dt>二</dt><dt>三</dt><dt>四</dt><dt>五</dt><dt class="d_th_bg">六</dt></dl><dl class="kui_date_info" id="kui_right_t"></dl></div><div class="kui_date_reset"><span class="sureSubmit">确认所选</span><span class="off">清空</span><span class="close">关闭</span></div></div></div>';
